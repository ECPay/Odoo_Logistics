...
LogisticsSubType = {
    ...
    'HILIFE': 'HILIFE',  # 萊爾富
    'FAMILY_C2C': 'FAMIC2C',  # 全家
    'UNIMART_C2C': 'UNIMARTC2C',  # 統一超商
    'HILIFE_C2C': 'HILIFEC2C',  # 萊爾富富
}
...
ECPayTestURL = {
    ...
    # 電子地圖
    'CVS_MAP': 'https://logistics-stage.ecpay.com.tw/Express/map',
    # 物流訂單建立
    'SHIPPING_ORDER': 'https://logistics-stage.ecpay.com.tw/Express/Create',
    # 宅配逆物流訂單
    'HOME_RETURN_ORDER': 'https://logistics-stage.ecpay.com.tw/Express/ReturnHome',
    # 超商取貨逆物流訂單(統一超商B2C)
    ...
    # 物流訂單查詢
    'QUERY_LOGISTICS_INFO': 'https://logistics-stage.ecpay.com.tw/Helper/QueryLogisticsTradeInfo/V2',
    # 產生托運單(宅配)/一段標(超商取貨)
    ...
    # 產生 B2C 測標資料
    'CREATE_TEST_DATA': 'https://logistics-stage.ecpay.com.tw/Express/CreateTestData',
}
...
class BasePayment(object):
    ...
    def generate_check_value(self, params):
        ...
        encrypt_type = int(_params.get('EncryptType', 0))
...
class CreateShippingOrder(BasePayment):
    ...
    def create_shipping_order(self, action_url=__url, client_parameters={}):
        ...
        if '1|' in response.text:
            ...
            query = dict(parse_qsl(response_text, keep_blank_values=True))
            return query
        else:
...
# V2.2.14 2018/09/12 調整超商取貨逆物流訂單(萊爾富超商B2C)API為暫停使用
